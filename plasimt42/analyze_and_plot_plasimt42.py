...
df = []
for n_ens in [2,4,10]:
    for pert_scale in [0.001,0.003,0.01,0.03,0.1 ,1, 3]:
        ifile=f'output/plasimt42_leadtime_vs_skill_and_spread_plasimt42_100_0_100_1_1_1_n_svs10_n_ens{n_ens}_pertscale{pert_scale}_nresample1_svdleadtime2.csv'
...
sub_netens = sub_rand.query('n_ens<=10') # netens we only have up to 10 members (the rest are dubplicates from 20 members)

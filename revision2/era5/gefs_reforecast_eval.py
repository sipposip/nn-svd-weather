...
regrid=True
if regrid:
    target_grid = xr.open_dataset('/climstorage/sebastian/nn_ensemble_nwp/gefs_reforecast/constants_2.5deg.nc')# only NH
...
truth_all = data.isel(fhour=0,ens=0)
...
for n_ens in range(1,10+1):
    ...
    pickle.dump(out,open(f'/home/sebastian/nn_ensemble_nwp/revision2/gefs/gefs_reforecast_scores_n_ens{n_ens}_regrid{regrid}.pkl','wb'))

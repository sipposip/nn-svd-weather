...
ax2.plot(sub_df['pert_scale'], sub_df['spread_netens'], label='spread netens', color='#d95f02', linestyle='--')
...
plt.title(f'leadtime:{leadtime} MTU')
plt.savefig(f'{plotdir}/lorenz95_pert_scale_vs_skill_spread_leadtime{leadtime}.svg')
...
sns.despine()
plt.title(f'leadtime:{leadtime} MTU')
plt.savefig(f'{plotdir}/lorenz95_pert_scale_vs_corr_leadtime{leadtime}.svg')
...
plt.ylabel('spread error correlation')
sns.despine()
plt.savefig(f'{plotdir}/lorenz95_pert_leadtime_vs_corr_spaghetti.svg')
